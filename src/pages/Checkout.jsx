...
import { useApp, PRODUCTS, BANJO_WALLET } from '../store.js';
...
function PayCard({ title, sub, glyph, glyphBg, chip, chipTone, active, onClick }) {
  return (

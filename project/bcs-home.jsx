// bcs-home.jsx — Home: Split Stage (Option B)
// Top marquee → stage left (Banjo art) + type wall right → bottom marquee →
// supporting strips: "what's coming", lore tease, newsletter.
    ...
    <div className="page">
      ...
      <section style={{
        ...
        <div style={{
          ...
          {/* Hero plush — turnaround over background */}
        ...
        <div style={{
          ...
          <div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, alignItems: 'center' }}>
              <button className="btn btn-accent btn-lg" onClick={() => go('checkout')} style={{ backgroundColor: "rgb(22, 149, 0)" }}>RESERVE · $0
      ...
      <section className="wrap" style={{ padding: '80px 24px 40px' }}>
        ...
        <div className="roadmap-grid" style={{
          ...
          style={{
            ...
            overflow: 'hidden',
            display: 'flex', flexDirection: 'column',
            aspectRatio: '4/5', height: "300px", gap: "0px", justifyContent: "flex-start", borderRadius: "5.33335px", borderWidth: "1.99996px", padding: "0px", margin: "0px"
          }}>
      ...
      <section style={{
        ...
        <div className="wrap" style={{
          ...
          <div>
            ...
            <div className="f-mono" style={{ marginTop: 24, fontSize: 11, color: 'var(--mute)', letterSpacing: '0.16em', textTransform: 'uppercase' }}>— @LORDKAHL ON X
          ...
          <div style={{
            ...
            style={{ objectPosition: 'center center', height: "400px", padding: "0px", margin: "0px", borderWidth: "0px", borderStyle: "solid", borderRadius: "0px", width: "600px", objectFit: "contain" }} />
          </div>
        </div>
      </section>

      {/* Plug in: Socials · Padlog · Chart */}
      <section className="wrap" style={{ padding: '80px 24px 40px' }}>
        ...
        <div className="plug-grid" style={{
          ...
          <div style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              <p style={{ fontSize: 13, marginTop: 12, opacity: 0.75, maxWidth: 280 }}>Stay updated on the next VALE Drop.
(Is it a free mint NFT next?)
      ...
      <style>{`
        ...
        @media (max-width: 720px) {
          section.wrap > div:first-child { flex-wrap: wrap; gap: 16px !important; }
          section[style*="grid-template-columns: 1fr 1fr"] { grid-template-columns: 1fr !important; gap: 32px !important; }
        }
      `}</style>
    </div>);
